...
export const viewerReviewWorkspace: ReviewWorkspace = {
  batches: [{
    batchId: "viewer-generation-batch",
    requestKey: "viewer-request-key",
    status: "ready_for_review",
    modelName: "로컬 규칙 모델",
    promptVersion: "고정 스키마 버전",
    baselineContentVersion: 0,
    releaseNotes: "승인 후 앱에 반영할 변경 요약이 표시되는 자리입니다.",
    minimumAppVersion: 1,
    progressPercent: 100,
    processingStage: "final_review_ready",
    attemptCount: 1,
    maxAttempts: 3,
    itemCount: 1,
    ...
    releaseId: null,
    releaseStatus: null,
    releaseContentVersion: null,
    releaseVersionName: null,
    createdAt: "변환 시각",
    completedAt: "완료 시각",
  }],
  items: [{
    generationItemId: "viewer-generation-item",
    batchId: "viewer-generation-batch",
    elementId: "요소 ID",
    entityType: "concept",
    entityKey: "콘텐츠 ID",
    baselineSnapshot: { definition_markdown: "변경 전 필드 값" },
    generatedSnapshot: { definition_markdown: "근거 기반으로 정돈된 변경 후 필드 값" },
    changedFields: ["definition_markdown"],
    changeSummary: "로컬 변환 변경 요약",
    confidence: 0.9,
    riskLevel: "low",
    validationSummary: { checksTotal: 3, checksPassed: 3, checksFailed: 0 },
    revisionId: null,
  }],
  evidence: [{
    generationEvidenceId: "viewer-generation-evidence",
    generationItemId: "viewer-generation-item",
    fieldPath: "definition_markdown",
    sourceFragmentId: "원문 fragment ID",
    supportRole: "primary",
    rationale: "이 원문이 변경 내용을 뒷받침하는 이유가 표시됩니다.",
    sourceLabel: "원본 자료명",
    sourceLocator: "원본 위치",
    fragmentLocator: { section: "원문 구간" },
    contentExcerpt: "검토자가 확인할 원문 인용 구절이 표시됩니다.",
  }],
  jobs: [],
};
